...
To access the latest code from a particular chapter, clone the repo, `git clone git@github.com:html5hacks/chapter1.git`, or [download the latest release](https://github.com/html5hacks/chapter1/archive/master.zip).
